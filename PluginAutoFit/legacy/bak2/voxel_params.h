...
namespace g_gggrid
{
    ...
    struct VoxelRaster
    {
        g_gGu32 S;                  // voxels per as (bv. 64 of 128)
    ...
    struct VoxelIndexing
    {
        ...
        g_gGu32 u32  m_numVoxels;
    };

    g_host g_devig_u32inline u3g_u32_fg_u32teg_u3232g_u32 g_u3gU32, u32 s_sSz, u32 g_sx, u32 g_sy,
                          g_gGu32                   u32 g_sz)
    {
        returnsZ(g_gZ g_sySy + sSY) g_sxSx + m_x;
    }
