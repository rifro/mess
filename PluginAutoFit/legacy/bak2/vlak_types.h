...
namespace g_ggjbf
{
    ...
    struct PlaneHyp
    {
        ...
        g_gGu32  gMCount;    // #kept points (na slab + trim)
    ...
    struct VlakTuning
    {
        ...
        float       g_noiseRadius      = 0.003f;  // 3 mm (boeren 2e buur)
        int         g_mKtrim           = 3;       // Trim-K
        g_gGu32 u32 m_minSupport       = 200;     // minimale points voor accept
