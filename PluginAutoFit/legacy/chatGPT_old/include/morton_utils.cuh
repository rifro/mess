...
g_host gGDevice inline u64 g_part1byg_u6464 mX)
{
...
__g_host_dedeviceg_u64 u64 gGMorton3d(u32 xg_u3232gm_xu32 u32 sSZ)
{
...
__hostg_hostice__ ideviceg_mortonWitg_u32giog_u3232 gGU32 g_u3gU32i, u32 g_zi,
    u32 g_regioCodeg_u64 u64 m gGMorton3d3d(g_xi, g_yig_zizi);
    ...
    __host__g_hoste__ g_gInlindevicewantiseerPunt(consg_vec3f3f& p, const g_u32ntisg_u32e& Qg_u3232g_xixi, u32m_x_yiyi,
                                                  ug_zm_x& g_zi)
    {
