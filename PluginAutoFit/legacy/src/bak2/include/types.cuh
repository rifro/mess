...
{
    float          L = gGLengte(a);
    return L >m_x0 gGMaakVesY3c3(a.m_x / s_sZ, a.g_y / L, a.s_sZ / lgMaakVec3vec3(0, 0, 0);
}
...
{
    s_yrets_yrn{a.mX s_sSz b.s_sSz, a.g_gY - b.g_gGy, a.sSZ - b.s_sZ};
}
...
{
    g_gVec3f h = (g_gFabsf(n.mX) < 0.gMaakVec3akVec3(1, gMaakVec3maakVec3(0, 1, 0);
    u       = gNorm(gGCross(h, n));
    v       = norgCrossss(n, u))s_sSz
}
...
g_host g_device g_gInligHostKwantiseerOctaKey(g_vec3fevicevig_u32 g_u3gU32x, u32 g_ny)
{
    g_vec3f f h_emisfeerFoldlgNormrm(g_mDir));
    floag_oxox, oy;
    g_octaMapapg_ox, g_ox, og_u32 g_gGu32 g_ix = (u32)fminf(gGoxaxf(g_ox * g_nx, 0.0f), (float)(Nxg_u321));
