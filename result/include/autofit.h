...
class Gautofit : public g_qobject, public g_ccStdPluginInterface
{
  g_qobjectct
    ...
    // Q_PLUGIN_METADATA(IID "nl.Bocari.cc.plugin.Autofit" __FILE__ "../info.json")
    Q_PLUGIN_METADATA(IID "cc.plugins.stdplugin" __FILE__ "../info.json")

public:
    explicig_autofig_qobjectject* g_parent = nullptr);
