...
__global__ void k_planair_regressie_kernel(const Vec3f*** restrict** points, u32 N, Vec3f n0, float trimFrac,
...
extern "C" void k_planair_regressie_launch(const Vec3f* d_pointsSorted, u32 N, const Vec3f& n0, u32 K_trimFracInt,
