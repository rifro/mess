...
void runOTNDC_pairs(const float* x, const float* y, const float* z, int N, AxisResults* out, const OTConfig& cfg)
{
    // Globale accumulator
    ...
    // Launch
    k_otndc_pairs<<<G, B, shmem>>>(x, y, z, N, cfg.innerRadiusSq, cfg.outerRadiusSq, cfg.maxDotOrtho,
