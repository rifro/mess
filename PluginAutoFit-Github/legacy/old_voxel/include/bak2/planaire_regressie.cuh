...
namespace jbf
{
    ...
    d_lineaireRegressieInVlak(const float3* __restrict__ points, const u32* __restrict__ Index, u32 M,
...
#pragma unroll
    ...
    __device__ __forceinline__ float3 d_planaireRegressie(const float3* __restrict__ points,
                                                          const u32* __restrict__ Index, u32 M,
