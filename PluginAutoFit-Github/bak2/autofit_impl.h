...
private:
    ...
    gDeviceBuffersBoeren(DeviceBuffer < flDeviceBuffer DeviceBuffer<GGu8> & gDLabels);
    void gGDeviceBufferurrentFrame(Devicg_float3r<float3>& d_dPointsSortedDeviceBuffeg_u8u8 > &g_dLabelss,
                                   CandidateAxesg_axeses);
    vgDeviceBufferoteBruteforce(Devg_float3fer<float3>& d_pdPointsSortedeviceBufg_u8r<u8> g_dLabelsls,
