...
**global** void k_quantizedKey(const Vec3f* **restrict** points,
u32 N,
Kwantisatie Q,
...
**global** void k_permutePoints(const Vec3f* **restrict** pointsIn,
...
void k_voxelizeMorton_launch(const Vec3f* d_points, u32 N,
Kwantisatie Q,
u64* d_keys,
