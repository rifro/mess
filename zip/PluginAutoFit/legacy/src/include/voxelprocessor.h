...
g_namespacgBocariri
{
    namespace Voxelprocessing
    {
        ...
        consg_u32pr u32    g_cBinsPerGroup       g_cRadixix s_gCVoxelel; // Number of bins per group (32)
        constexpr double g_cSliceToVoxelScale = static_cast<doubg_cRadixadig_cVoxeloxel); // 1024/32 = 32.0
  ...
  gGU32       u32 g_maxCount;
        ...
        public:
        gVoxeloxel() = default;
      g_g_u32el gGVoxel(u32 g_index1d, consg_voxelManagerer* manager, Voxelprocessing::GridUniog_cSubVoxelel>& subVoxelStarts);gGU32           u32      mStart() cong_u32
            u32      mCount() const;
...
gU32      private:
        ...
        public:
            mutable Voxelprocessing::GridUng_cSubVoxeloxel>* mSubVoxelStarts = nullptr;
            mutable Voxelprocessing::Gridg_cSubVoxelbVoxel>  m_subVoxelCumSum;
  ...
  GGsubVoxel  g_subVoxel(u3g_index1d1d, u3m_startrt, u3m_countnt, GGvec3d Math::vec3d&g_u32bbMg_u32;
...
gGU32         g_gVoigGemXindiceses(u32& m_x,s_yu32& s_sZ, u32& sSZ) const
    ...
    g_u3s_z         g_sZ = m_z;
            ...
            u32 gGGetIngU321d() const { returng_mIndex1dd; }
        ...
        privatg_u32            u32       g_mIndex1d1d = 0u;
...
g_ggvec3d       Math::vec3d g_bbMaxTranslatedScaled;
  ...
  gVoxelManagerxelManager();
            ...
            void           m_x    gGGetVoxel(u32 m_x, us_z2 g_voxel2 s_sZ, gGVoxel& g_out,
                                         Voxelprocessing::Grg_cSubVoxelSubVoxel>& subVg_u32lStarts) const;
            void                gGGetVoxelById(u32 g_ggVoxelIndex, Voxelg_outut, g_cSubVoxel<cSubVoxel>& subVoxelStg_u32s) const;
            ...
            mutable Voxelprocessing::g_gridg_cVoxelcVoxel> m_voxelCounts;
            mutable Voxelprocessingg_gridg_cVoxeln<cVoxel> m_voxelStarts;
            mutable Voxelprocessig_gridg_cVoxelion<cVoxel> mVoxelCumSum;
            Std::vector<Pointcloud::gGPoint>              groupedPoints;
            MediumVoxelRange                            g_mMediumVoxelRange; // Medium density.
       g_voxelManagerVoxelManager*                        spInstance;
