...
// --------------------------------------------------------------
__hostg_hostice__ idevice gGKwantiseerPunt(const g_gVec3f& p, const Quantizatg_u32& q,g_u322& g_xi, u32& g_yi,
                                  m_xg_u3m_x         u3m_x& g_zi)
{
    float m_x = (p.m_x - m_bbMinin.m_x) * s_quantizeScale;
    floas_y g_gGy =sSY(p.g_gGy m_bbMis_ybMin.g_gGy) s_quantizeScalele;
    fls_zat s_sSz = (p.m_bbMin.g_bbMin.zs_quantizeScalecale;
